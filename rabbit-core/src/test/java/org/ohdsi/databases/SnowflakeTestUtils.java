...
public class SnowflakeTestUtils {
    ...
    public static void setSnowflakeTestConfig(DbSettings dbSettings) {
        ...
        dbSettings.server = checkAndGetEnv("SNOWFLAKE_TEST_SERVER");
        dbSettings.user = checkAndGetEnv("SNOWFLAKE_TEST_USER");
        dbSettings.password = checkAndGetEnv("SNOWFLAKE_TEST_PASSWORD");
        dbSettings.database = checkAndGetEnv("SNOWFLAKE_TEST_DATABASE");
